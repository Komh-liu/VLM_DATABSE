...
Do not modify or delete files inside any skill that is a symlink (symlinks point into `/home/liu/GitRepo/Auto-Codex-research-in-sleep`).
Update with: `bash /home/liu/GitRepo/Auto-Codex-research-in-sleep/tools/install_aris.sh`  (re-runnable; reconciles new/removed skills).
<!-- ARIS:END -->
